...
<head>
    <title>Trial expired | StaffLife</title>
...
<div class="bgbighome">
<div class="caption">
   <h1 class="splashdesk" style="font-weight:400;">Trial Expired</h1>
   <h1 class="splashmob" style="font-weight:400; color:#666666;">Trial Expired</h1>
   <p style="color:#666666;">Your trial has expired, please click the button below to pay your package and continue using it.</p>
   <div class="text-center">
      <a class="btn success" href="{{ route('pay-package') }}">Pay Now</a>
   </div>
</div>
</div>
