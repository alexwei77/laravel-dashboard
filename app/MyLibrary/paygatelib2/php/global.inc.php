<?php
	 ...
	 * @return string
	 */
	function getFinalDirectory1($urlArray){
	...
	function generateReference1(){
		return 'pgtest_' . getDateTime1('YmdHis');
	}

	function getDateTime1($format){
		$dateTime = new DateTime();
		return $dateTime->format($format);
	}

	function generateCountrySelectOptions1(){
		$options = '';
		$country = 'ZAF';
	...
	$fullPath1  = getCurrentUrl1();
	$root1      = getRoot1($fullPath1);
	$directory1 = getFinalDirectory1($fullPath1);