<ul id="menu" class="page-sidebar-menu">
    <li {!! (Request::is('admin') ? 'class="active"' : '') !!}>
     ...
     <li {!! ((Request::is('admin/packages/packages') || Request::is('admin/blogcategory/create') || Request::is('admin/blog') ||  Request::is('admin/blog/create')) || Request::is('admin/blog/*') || Request::is('admin/blogcategory/*') ? 'class="active"' : '') !!}>
        <a href="#">
            <i class="livicon" data-name="comment" data-c="#ee6f00" data-hc="#ee6f00" data-size="18"
               data-loop="true"></i>
            <span class="title">Packages</span>
            <span class="fa arrow"></span>
        </a>
        <ul class="sub-menu">
            <li {!! (Request::is('admin/packages/packages') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('admin/packages/packages') }}">
    ...
    <li {!! (Request::is('admin/subscriptions') || Request::is('admin/subscriptions/create') || Request::is('admin/subscriptions/*') ? 'class="active"' : '') !!}>
        <a href="#">
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/groups/create') ? 'class="active" id="active"' : '') !!}>
                <a href="{{ URL::to('admin/metrics/metricadd') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Add new scoring metric
                </a>
            </li>
            <li {!! (Request::is('admin/groups/allcountries') ? 'class="active" id="active"' : '') !!}>
                <a href="{{ URL::to('admin/subscriptions/allcountries') }}">
                    <i class="fa fa-angle-double-right"></i>
    ...
    <!-- <li {!! (Request::is('admin/subscriptions') || Request::is('admin/subscriptions/create') || Request::is('admin/subscriptions/*') ? 'class="active"' : '') !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/groups') ? 'class="active" id="active"' : '') !!}>
                <a href="{{ URL::to('admin/subscriptions/allsubscriptions') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Memberships
                </a>
            </li>-->
            ...
            <!--<li {!! (Request::is('admin/groups/create') ? 'class="active" id="active"' : '') !!}>
                <a href="{{ URL::to('admin/subscriptions/pricesadd') }}">
                    <i class="fa fa-angle-double-right"></i>
    ...
    <li {!! (Request::is('admin/generator_builder') ? 'class="active"' : '') !!}>
        <a href="{{  URL::to('admin/generator_builder') }}">
            <i class="livicon" data-name="shield" data-size="18" data-c="#ee6f00" data-hc="#ee6f00"
               data-loop="true"></i>
            Generator Builder
        </a>
    </li>
   ...
   <li {!! (Request::is('admin/animatedicons') || Request::is('admin/buttons') || Request::is('admin/advanced_buttons') || Request::is('admin/tabs_accordions') || Request::is('admin/panels') || Request::is('admin/icon') || Request::is('admin/color') || Request::is('admin/grid') || Request::is('admin/carousel') || Request::is('admin/advanced_modals') || Request::is('admin/tagsinput') || Request::is('admin/nestable_list') || Request::is('admin/sortable_list') || Request::is('admin/toastr') || Request::is('admin/notifications')|| Request::is('admin/treeview_jstree')|| Request::is('admin/sweetalert') || Request::is('admin/session_timeout') || Request::is('admin/portlet_draggable') ? 'class="active"' : '') !!}>
        <a href="#">
            <i class="livicon" data-name="brush" data-c="#ee6f00" data-hc="#ee6f00" data-size="18"
               data-loop="true"></i>
    ...
    <li {!! (Request::is('admin/calendar') ? 'class="active"' : '') !!}>
        <a href="{{ URL::to('admin/calendar') }}">
            <i class="livicon" data-c="#ee6f00" data-hc="#ee6f00" data-name="calendar" data-size="18"
               data-loop="true"></i>
            Calendar
    ...
    <li {!! ((Request::is('admin/vouchers/create-voucher') ? 'class="active"' : '')) !!}>
        <a href="#">
            <i class="livicon" data-name="gift" data-c="#ee6f00" data-hc="#ee6f00" data-size="18"
               data-loop="true"></i>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/vouchers/create-voucher') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('admin/vouchers/create-voucher') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Generate Voucher
                </a>
            </li>
