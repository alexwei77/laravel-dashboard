                                ...
                                <ul class="nav nav-tabs ul-edit responsive">
                                    <li class="active">
                                        <a href="#tab-activity" data-toggle="tab">
                                            <i class="livicon" data-name="comments" data-size="16" data-c="#4caf50" data-hc="#4caf50" data-loop="true"></i> Activity
                                        </a>
                                    </li>

                                    <li>
                                        <a href="#tab-messages" data-toggle="tab">
                                            <i class="livicon" data-name="mail" data-size="16" data-c="#4caf50" data-hc="#4caf50" data-loop="true"></i> Messages
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#tab-change-pwd" data-toggle="tab">
                                            <i class="livicon" data-name="key" data-size="16" data-c="#4caf50" data-hc="#4caf50" data-loop="true"></i> Change Password
                                        </a>
                                    </li>
                                </ul>
