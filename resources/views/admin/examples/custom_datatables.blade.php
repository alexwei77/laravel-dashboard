                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-md-offset-4">
                                    ...
                                    <div> <b class="margin_right15">1</b>
                                        <input id="id_range" type="text" data-slider-id='id_range' class="slider form-control" data-slider-handle="square" value="" data-slider-min="1" data-slider-max="{{$max_count}}" data-slider-step="1" data-slider-value="[1,3]"/> <b style="margin-left: 15px;">@if(!empty($max_count)){{$max_count}} @else 10 @endif</b>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div> <b class="margin_right15">1</b>
                                        <input id="id_range2" type="text" data-slider-id='id_range' class="slider form-control" data-slider-handle="square" value="" data-slider-min="1" data-slider-max="10" data-slider-step="1" data-slider-value="[1,3]"/> <b style="margin-left: 15px;">@if(!empty($max_count)){{$max_count}} @else 10 @endif</b>
                                    </div>
                                </div>
