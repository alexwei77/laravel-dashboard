<div class="modal-header">
  ...
  <h4 class="modal-title" id="user_delete_confirm_title">Please confirm deletion of membership</h4>
</div>
<div class="modal-body">
    @if($error)
        <div>{!! $error !!}</div>
    @else
        Are you sure you want to delete this membership? This operation is irreversible.
    @endif
</div>
