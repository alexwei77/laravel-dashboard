...
<head>
    ...
    <title>Email verified | StaffLife</title>
...
<div class="bgbighome">
    <div class="caption">
        <h1 class="splashdesk" style="font-weight:400;">Email verification successful</h1>
        <h1 class="splashmob" style="font-weight:400; color:#666666;">Email verification successful</h1>
        <p style="color:#666666;"></p>
        <div class="text-center">
            <a class="btn info" href="{{ route('home') }}">HOME</a>
            @if(Sentinel::guest())
            <a class="btn success" href="{{ route('login') }}">LOG IN</a>
            @else
            <a class="btn success" href="{{ route('verify-company') }}">Go to Dashboard</a>
            @endif
       </div>
    </div>
</div>
