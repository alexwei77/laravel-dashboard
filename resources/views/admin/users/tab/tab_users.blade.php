                  ...
                  <div class="row">
                     <div class="tabbable">
                        <ul class="nav nav-tabs" id="">
                           ...
                           <li class="active"><a href="{{ route('admin.members.edit.users', $user->id) }}">Users</a></li>
                                             ...
                                             <table class="table table-striped" id="table5">
                                                <thead>
                                                   <tr class="filters">
                                                      ...
                                                      <th title="Click to order">User acc #</th>
                                                      <th title="Click to order">Started</th>
   ...
   $(function() {
       ...
       var table5 = $('#table5').DataTable({
           ...
           "pageLength": 100,
            order:[[ 0, "desc" ]],
           ajax: {
               url: "{{ action('Members\MembersController@get_users') }}",
               data: function (d) {
