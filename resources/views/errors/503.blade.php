...
<head>
    ...
    <title>Maintenance | StaffLife</title>
...
<div class="bgbighome">
<div class="caption">
   <h1 class="splashdesk" style="font-weight:400;">Site Maintenance In Progress</h1>
   <h1 class="splashmob" style="font-weight:400; color:#666666;">Site Maintenance In Progress</h1>
   <p style="color:#666666;">We're updating the site, check back in a bit...</p>
</div>
</div>
