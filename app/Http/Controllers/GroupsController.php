...
class GroupsController extends JoshController
{
    ...
    public function store(GroupRequest $request)
    {
        if ($role = Sentinel::getRoleRepository()->createModel()->create([
            ...
            return Redirect::route('admin.groups')->with('success', Lang::get('groups/message.success.create'));
        }
    ...
    public function update($id = null, GroupRequest $request)
    {
        try {
            ...
            // Redirect to the groups management page
            return Rediret::route('admin.groups')->with('error', Lang::get('groups/message.group_not_found', compact('id')));
        }
        ...
        if ($group->save()) {
            ...
            return Redirect::route('admin.groups')->with('success', Lang::get('groups/message.success.update'));
        } else {
            // Redirect to the group page
            return Redirect::route('admin.groups.edit', $id)->with('error', Lang::get('groups/message.error.update'));
        }
    ...
    public function destroy($id = null)
    {
        try {
            ...
            return Redirect::route('admin.groups')->with('success', Lang::get('groups/message.success.delete'));
        } catch (GroupNotFoundException $e) {
            // Redirect to the group management page
            return Redirect::route('admin.groups')->with('error', Lang::get('groups/message.group_not_found', compact('id')));
        }
