...
$url = $disk->url('/users/' . Sentinel::getUser()->pic);
?>

<body class="skin-josh">
<header class="header">
    <a href="{{ route('admin.dashboard') }}" class="logo">
        <img src="{{ asset('assets/img/logodmmx.jpg') }}" alt="logo">
    </a>
                    ...
                    <ul class="sidebar_threeicons">
                        <li>
                            <a href="{{ URL::to('admin/subscriptions/allcountries') }}">
                                <i class="livicon" data-name="image" title="All Countries/Prices" data-loop="true"
                                   data-color="#ee6f00" data-hc="#ee6f00" data-s="25"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('admin/blog') }}">
                                <i class="livicon" data-name="list-ul" title="Blog List" data-loop="true"
                                   data-color="#e9573f" data-hc="#e9573f" data-s="25"></i>
                            </a>
                        </li>
                        <li>
                            <a href="{{ URL::to('admin/groups') }}">
                                <i class="livicon" data-name="users" title="Groups" data-loop="true"
